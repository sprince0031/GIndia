...
| :--- | :--- | :--- | :--- |
| `kiosk_mode_narration` | Exhibition Kiosk Mode & Local Audio Narration | Implement automated hands-free exhibition tour loop, camera lerping, and Web Speech API audio narration. | `[ ] In Progress` |
...
- [ ] **Track: Exhibition Kiosk Mode & Local Audio Narration**
*Link: [./conductor/tracks/kiosk_mode_narration/](./conductor/tracks/kiosk_mode_narration/)*