...
| :--- | :--- | :--- | :--- |
| `threejs_map_engine` | Three.js 3D Interactive Map Engine | Implement `SVGLoader` extrusion from `in.svg`, warm gallery lighting, terracotta highlight materials, raycasting state selection, and hover elevation. | `[ ] In Progress` |
...
- [ ] **Track: Three.js 3D Interactive Map Engine**
