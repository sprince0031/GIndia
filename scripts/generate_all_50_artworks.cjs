...
const CATEGORY_STYLES = {
  'Handicraft': { primary: '#1E3A8A', secondary: '#3B82F6', accent: '#F59E0B', bg1: '#0F172A', bg2: '#1E293B' },
  'Handicrafts': { primary: '#1E3A8A', secondary: '#3B82F6', accent: '#F59E0B', bg1: '#0F172A', bg2: '#1E293B' },
  'Agricultural': { primary: '#14532D', secondary: '#22C55E', accent: '#FACC15', bg1: '#052E16', bg2: '#14532D' },
  'Food Stuff': { primary: '#7C2D12', secondary: '#EA580C', accent: '#FDE047', bg1: '#431407', bg2: '#7C2D12' },
  'Manufactured': { primary: '#581C87', secondary: '#A855F7', accent: '#38BDF8', bg1: '#2E1065', bg2: '#581C87' },
  'Natural Goods': { primary: '#713F12', secondary: '#CA8A04', accent: '#86EFAC', bg1: '#422006', bg2: '#713F12' }
};

// 100% Comprehensive Bespoke SVG Renderers for All 50 Spotlight Products
...
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400">
  ...
  // Write valid SVG file
  const svgPath = path.join(outDir, `${product.id}.svg`);
  fs.writeFileSync(svgPath, fullSvg, 'utf8');

  // Update product.imageUrl to .svg in database
  product.imageUrl = `assets/gi-images/${product.id}.svg`;
  generatedCount++;
}

// Write updated database with .svg references
fs.writeFileSync(dbPath, JSON.stringify(db, null, 2), 'utf8');
console.log(`✅ Generated all ${generatedCount} individual bespoke SVG artworks and updated gi_database.json!`);
